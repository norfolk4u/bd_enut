...
router.get('/ENUT2024/capacitacion/seguimiento_cursos/reporte/:visu/:tipo_rpt/:nivel/:nro_cap/:nro_aula/:exam/:cod_sede/:cod_cargo', capacitacion_controller.getRptSeguimientoCursos);
