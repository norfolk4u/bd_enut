...
router.get('/ENUT2024/capacitacion/seguimiento_cursos/reportes_1/:visu/:tipo_rpt/:nivel/:nro_cap/:nro_aula/:exam/:cod_sede/:cod_cargo', capacitacion_controller.getSeguimientoCurso_1);
