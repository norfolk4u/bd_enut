...
router.get('/ENUT2024/reclutamiento/indicador_cobertura_cobertura_diaria/:visu/:tipo_rpt/:id_proyecto/:nivel/:id_cc/:cod/:anio_f', reclutamiento_controller.getIndicadorCoberturaCoberturaDiaria );
